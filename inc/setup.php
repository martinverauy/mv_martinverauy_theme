...
if ( ! function_exists( 'mv_martinverauy_theme_setup' ) ) :
	/**
	 ...
	 */
	function mv_martinverauy_theme_setup() {
		/*
		* Make theme available for translation.
		* Translations can be filed in the /languages/ directory.
		* If you're building a theme based on MV_MartinVeraUy_Theme, use a find and replace
		* to change 'MV_MartinVeraUy_Theme' to the name of your theme in all the template files.
		*/
		load_theme_textdomain( 'MV_MartinVeraUy_Theme', get_template_directory() . '/languages' );
...
add_action( 'after_setup_theme', 'mv_martinverauy_theme_setup' );
 ...
 */
function mv_martinverauy_theme_content_width() {
	$GLOBALS['content_width'] = apply_filters( 'mv_martinverauy_theme_content_width', 640 );
}

add_action( 'after_setup_theme', 'mv_martinverauy_theme_content_width', 0 );
